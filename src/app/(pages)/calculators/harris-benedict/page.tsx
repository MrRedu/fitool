      ...
      <div className="max-w-4xl m-auto lg:p-16 p-8 space-y-16">
        <section className="text-center space-y-4">
          <Typography variant="large">
            ...
            las <strong>calorías diarias</strong> que gastas (en total) según la
        ...
        <section className="space-y-4">
          ...
          <Typography>
            En el ámbito de la{' '}
            <strong>salud, la nutrición y el ejercicio</strong>, es fundamental
            comprender y calcular las calorías necesarias para mantener,
            aumentar o disminuir el peso corporal.
          </Typography>
          <Typography>
            La fórmula de <strong>{`Harris – Benedict`}</strong>, desarrollada
            en 1918, es ampliamente utilizada para estimar las calorías diarias
            necesarias para el metabolismo basal y la actividad física.
            Concretamente,{' '}
          ...
          <Typography>
            A continuación, exploraremos en detalle esta fórmula, su utilidad y
            sus limitaciones, y también discutiremos alternativas y enfoques
          ...
          <Typography>
            ...
            <em>Tasa Metabólica Basal (TMB)</em>, que es la cantidad de energía
            necesaria para mantener las funciones vitales del organismo en
            reposo.
          </Typography>
          <Typography>
          ...
          <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
            ...
            <li>
              <Typography>
                ...
                diferente: <br />
                RMB = 655 + (9.56 x peso en kg) + (1.85 x altura en cm) - (4.68
                x edad en años)
              </Typography>
            </li>
          </ul>
          <Typography>
            En 1990, Mifflin y St. Jeor revisaron la fórmula original de Harris
            – Benedict <strong>para mejorar la precisión</strong> y tener en
            cuenta las diferencias en el sexo y en la{' '}
          ...
          <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
            <li>
              <Typography>
                <strong>Para hombres</strong>: RMB = (10 x peso en kg) + (6.25 x
                altura en cm) – (5 x edad en años) + 5
              </Typography>
            </li>
            <li>
              <Typography>
                <strong>Para mujeres</strong>: RMB = (10 x peso en kg) + (6.25 x
